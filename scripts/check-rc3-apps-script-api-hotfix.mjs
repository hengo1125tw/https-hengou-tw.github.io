...
const checks = [
  ["version file rc3", ["v1.2.0-rc.3", "v1.2.0-rc.4", "v1.2.0-rc.5", "v1.2.0-rc.6"].includes(version)],
  ["package rc3", ["1.2.0-rc.3", "1.2.0-rc.4", "1.2.0-rc.5", "1.2.0-rc.6"].includes(pkg.version)],
  ["admin html rc3", (adminHtml.includes("v1.2.0-rc.3") || adminHtml.includes("v1.2.0-rc.4") || adminHtml.includes("v1.2.0-rc.5", "v1.2.0-rc.6"))],
