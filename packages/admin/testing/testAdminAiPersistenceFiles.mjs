...
const checks = [
  ...
  ["production version", (html.includes("v1.2.0-rc.1") || html.includes("v1.2.0-rc.2") || html.includes("v1.2.0-rc.3") || html.includes("v1.2.0-rc.4") || html.includes("v1.2.0-rc.5", "v1.2.0-rc.6"))],
